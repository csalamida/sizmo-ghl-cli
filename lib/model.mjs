...
export const ENTITY_SPECS = [
  ...
  {
    name: 'forms',
    buildPath: (loc) => `/forms/?locationId=${encodeURIComponent(loc)}&limit=50`,
    version: '2021-07-28',
  ...
  {
    name: 'products',
    buildPath: (loc) => `/products/?locationId=${encodeURIComponent(loc)}&limit=50`,
    version: '2021-07-28',
  ...
  {
    name: 'businesses',
    buildPath: (loc) => `/businesses/?locationId=${encodeURIComponent(loc)}&limit=50`,
    version: '2021-07-28',
