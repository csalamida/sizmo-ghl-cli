...
const COMMAND_EXAMPLES = {
  ...
  calendar:     ['sizmo calendar create --name "Discovery Calls" --confirm', 'sizmo calendar create --name "Demos" --slot-min 45 --confirm', 'sizmo calendar delete <calendarId> --confirm'],
